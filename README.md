...
[![Amazon ADPB v1.3.3](badge.svg)](https://github.com/ExtraPotions/dark-pattern-blockers/releases/tag/v1.3.5)
...
**Version 1.3.5** · By [expDARE](https://github.com/ExtraPotions) · [What's new](CHANGELOG.md)
...
- Compact 280px charcoal tabbed menu with denser spacing, accessible toggle buttons and descriptions.
- Compact icon header, a two-row category tab bar and sentence-case labels keep the menu easy to scan.
...
- The title, close button and category tabs remain visible; overflow scrolls inside the selected panel. Use arrow keys to navigate tabs.
- Categories with six or fewer settings show every item directly; larger categories offer Show more.
