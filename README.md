...
<p align="center">
  Strip common Amazon dark patterns on <strong>amazon.com</strong> — Prime upsells, urgency, sponsored junk, Rufus, and more — with a floating settings panel.
</p>
...
**Author:** [expDARE](https://github.com/ExtraPotions) · **Latest:** [v0.1.30](https://github.com/ExtraPotions/velvet-crane-orbit/releases/tag/v0.1.30)

| Stat | Value |
|------|-------|
| Toggleable filters | **13** |
| Userscript | `amazon-dark-pattern-blocker.user.js` |
| Runs on | `amazon.com` / `www.amazon.com` |
...
4. Visit amazon.com — dark-pattern chrome gets stripped per your toggles.

`@downloadURL` / `@updateURL` point at the release asset, so installs and auto-updates count in the download badge above.
...
Floating favicon button on the right (drag up/down). Orange switches = on. Most changes apply live without a refresh.
